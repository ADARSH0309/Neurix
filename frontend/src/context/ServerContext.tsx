...
const GATEWAY_URL = import.meta.env.VITE_MCP_SERVER_URL || 'http://localhost:8080';
...
export function ServerProvider({ children }: { children: ReactNode }) {
    ...
    const connectServer = (serverId: string) => {
        ...
        toast.info('On the Google sign-in screen, click "Advanced" → "Go to neurixgateway..." to continue.', { duration: 10000 });
