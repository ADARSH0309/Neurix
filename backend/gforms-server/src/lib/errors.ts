/**
 * Custom Error Classes for Google Forms MCP Server
 *
 ...
 * Wraps Google Forms-specific API errors
 */
export class GformsApiError extends McpError {
  constructor(
    message: string,
    ...
    super(message, statusCode, 'GFORMS_API_ERROR');
  }
}
...
export function isRetryableError(error: unknown): boolean {
  ...
  if (error instanceof GformsApiError) {
