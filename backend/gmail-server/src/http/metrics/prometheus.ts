 ...
 * 6. Gmail circuit breaker state changes
 */
...
/**
 * Gmail Circuit Breaker State Changes Total Counter
 */
export const gmail_circuit_breaker_state_changes_total = new Counter({
  name: 'gmail_circuit_breaker_state_changes_total',
  help: 'Total number of Gmail circuit breaker state changes',
