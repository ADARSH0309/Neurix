...
export const gsheets_circuit_breaker_state_changes_total = new Counter({
  name: 'gsheets_circuit_breaker_state_changes_total',
  help: 'Total number of Google Sheets circuit breaker state changes',
