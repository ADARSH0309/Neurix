/**
 * Zod Validation Schemas for Google Sheets MCP Server
 */
 ...
 */
export const spreadsheetIdSchema = z.string().min(1, 'Spreadsheet ID required').max(256, 'Spreadsheet ID too long');

export const readRangeParamsSchema = z.object({
  spreadsheetId: spreadsheetIdSchema,
  range: z.string().min(1, 'Range required').max(500, 'Range too long'),
...
export const writeRangeParamsSchema = z.object({
  spreadsheetId: spreadsheetIdSchema,
  range: z.string().min(1, 'Range required').max(500, 'Range too long'),
  values: z.array(z.array(z.any())).min(1, 'Values required'),
...
export const schemas = {
  ...
  readRangeParams: readRangeParamsSchema,
  writeRangeParams: writeRangeParamsSchema,
