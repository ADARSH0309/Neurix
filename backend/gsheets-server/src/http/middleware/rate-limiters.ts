...
export const authLimiter = rateLimit({
  ...
  legacyHeaders: false,
  store: new IORedisStore({ prefix: 'rl:gsheets:auth:' }),
  handler: (req, res) => {
...
export const apiLimiter = rateLimit({
  ...
  standardHeaders: true,
  legacyHeaders: false,
  store: new IORedisStore({ prefix: 'rl:gsheets:api:' }),
  handler: (req, res) => {
    console.error(JSON.stringify({
      timestamp: new Date().toISOString(),
      level: 'warn',
...
export const tokenGenerationLimiter = rateLimit({
  ...
  standardHeaders: true,
  legacyHeaders: false,
  store: new IORedisStore({ prefix: 'rl:gsheets:token:' }),
  handler: (req, res) => {
    console.error(JSON.stringify({
      timestamp: new Date().toISOString(),
      level: 'warn',
...
export const sseLimiter = rateLimit({
  ...
  standardHeaders: true,
  legacyHeaders: false,
  store: new IORedisStore({ prefix: 'rl:gsheets:sse:' }),
  handler: (req, res) => {
    console.error(JSON.stringify({
      timestamp: new Date().toISOString(),
      level: 'warn',
...
export const generalLimiter = rateLimit({
  ...
  standardHeaders: true,
  legacyHeaders: false,
  store: new IORedisStore({ prefix: 'rl:gsheets:general:' }),
  handler: (req, res) => {
    console.error(JSON.stringify({
      timestamp: new Date().toISOString(),
      level: 'warn',
...
export const gdprDeletionLimiter = rateLimit({
  ...
  standardHeaders: true,
  legacyHeaders: false,
  store: new IORedisStore({ prefix: 'rl:gsheets:gdpr:delete:' }),
  handler: (req, res) => {
...
export const gdprExportLimiter = rateLimit({
  ...
  standardHeaders: true,
  legacyHeaders: false,
  store: new IORedisStore({ prefix: 'rl:gsheets:gdpr:export:' }),
  handler: (req, res) => {
