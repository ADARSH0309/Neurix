/**
 * Custom Error Classes for Google Sheets MCP Server
 *
 ...
 * Wraps Google Sheets-specific API errors
 */
export class GsheetsApiError extends McpError {
  constructor(
    message: string,
    ...
    super(message, statusCode, 'GSHEETS_API_ERROR');
  }
}
...
export function isRetryableError(error: unknown): boolean {
  ...
  if (error instanceof GsheetsApiError) {
