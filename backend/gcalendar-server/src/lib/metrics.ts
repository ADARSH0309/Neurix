/**
 * Prometheus Metrics for Google Calendar MCP Server
 *
...
export const toolCallCounter = new promClient.Counter({
  name: 'gcalendar_mcp_tool_calls_total',
...
export const toolCallDuration = new promClient.Histogram({
  name: 'gcalendar_mcp_tool_call_duration_seconds',
...
export const activeToolCalls = new promClient.Gauge({
  name: 'gcalendar_mcp_active_tool_calls',
...
export const activeSessions = new promClient.Gauge({
  name: 'gcalendar_mcp_active_sessions',
...
export const sessionEvents = new promClient.Counter({
  name: 'gcalendar_mcp_session_events_total',
...
export const oauthEvents = new promClient.Counter({
  name: 'gcalendar_mcp_oauth_events_total',
...
// ============================================================================
// Google Calendar API Metrics
// ============================================================================

/**
 * Counter: Google Calendar API calls
 */
export const gcalendarApiCalls = new promClient.Counter({
  name: 'gcalendar_mcp_gcalendar_api_calls_total',
...
/**
 * Histogram: Google Calendar API latency
 */
export const gcalendarApiLatency = new promClient.Histogram({
  name: 'gcalendar_mcp_gcalendar_api_latency_seconds',
  help: 'Google Calendar API call latency in seconds',
...
export const circuitBreakerState = new promClient.Gauge({
  name: 'gcalendar_mcp_circuit_breaker_state',
...
export const circuitBreakerEvents = new promClient.Counter({
  name: 'gcalendar_mcp_circuit_breaker_events_total',
...
export const rateLimitEvents = new promClient.Counter({
  name: 'gcalendar_mcp_rate_limit_events_total',
...
export const errorCounter = new promClient.Counter({
  name: 'gcalendar_mcp_errors_total',
...
export const httpRequestsTotal = new promClient.Counter({
  name: 'gcalendar_mcp_http_requests_total',
...
export const httpRequestDuration = new promClient.Histogram({
  name: 'gcalendar_mcp_http_request_duration_seconds',
...
/**
 * Record Google Calendar API call metrics
 */
export function recordGcalendarApiCall(
  operation: string,
  status: 'success' | 'error',
  durationMs: number
): void {
  gcalendarApiCalls.inc({ operation, status });
  gcalendarApiLatency.observe({ operation }, durationMs / 1000);
}
