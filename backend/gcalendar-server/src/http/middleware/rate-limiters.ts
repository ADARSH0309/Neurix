...
export const authLimiter = rateLimit({
  ...
  legacyHeaders: false,
  store: new IORedisStore({ prefix: 'rl:gcalendar:auth:' }),
  handler: (req, res) => {
...
export const apiLimiter = rateLimit({
  ...
  standardHeaders: true,
  legacyHeaders: false,
  store: new IORedisStore({ prefix: 'rl:gcalendar:api:' }),
  handler: (req, res) => {
    console.error(JSON.stringify({
      timestamp: new Date().toISOString(),
      level: 'warn',
    ...
    res.status(429).json({
      jsonrpc: '2.0',
      error: { code: -32000, message: 'Rate limit exceeded', data: { retryAfter: 900, limit: 100, window: '15 minutes' } },
      id: null,
    });
  },
});
...
export const tokenGenerationLimiter = rateLimit({
  ...
  standardHeaders: true,
  legacyHeaders: false,
  store: new IORedisStore({ prefix: 'rl:gcalendar:token:' }),
  handler: (req, res) => {
    console.error(JSON.stringify({
      timestamp: new Date().toISOString(),
      level: 'warn',
...
export const sseLimiter = rateLimit({
  ...
  standardHeaders: true,
  legacyHeaders: false,
  store: new IORedisStore({ prefix: 'rl:gcalendar:sse:' }),
  handler: (req, res) => {
    console.error(JSON.stringify({
      timestamp: new Date().toISOString(),
      level: 'warn',
...
export const generalLimiter = rateLimit({
  ...
  standardHeaders: true,
  legacyHeaders: false,
  store: new IORedisStore({ prefix: 'rl:gcalendar:general:' }),
  handler: (req, res) => {
    console.error(JSON.stringify({
      timestamp: new Date().toISOString(),
      level: 'warn',
...
export const gdprDeletionLimiter = rateLimit({
  ...
  standardHeaders: true,
  legacyHeaders: false,
  store: new IORedisStore({ prefix: 'rl:gcalendar:gdpr:delete:' }),
  handler: (req, res) => {
...
export const gdprExportLimiter = rateLimit({
  ...
  standardHeaders: true,
  legacyHeaders: false,
  store: new IORedisStore({ prefix: 'rl:gcalendar:gdpr:export:' }),
  handler: (req, res) => {
