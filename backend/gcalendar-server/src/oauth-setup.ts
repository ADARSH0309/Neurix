...
/**
 * OAuth setup script for Google Calendar
...
async function getNewTokenManual(oauth2Client: any, tokenPath: string) {
  ...
  console.log('\n===========================================');
  console.log('Google Calendar OAuth Setup (Manual)');
  console.log('===========================================\n');
...
async function main() {
  ...
  const redirectUri = process.env.GOOGLE_REDIRECT_URI || 'http://localhost:8083/oauth/callback';
  ...
  const port = parseInt(redirectUrl.port) || 8083;
