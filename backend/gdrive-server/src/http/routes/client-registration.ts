...
router.get('/register/:client_id', async (req: Request, res: Response) => {
  try {
    ...
    const client = await clientRegistrationManager.getClient(client_id as string);
...
router.delete('/register/:client_id', async (req: Request, res: Response) => {
  try {
    ...
    const deleted = await clientRegistrationManager.deleteClient(client_id as string);
