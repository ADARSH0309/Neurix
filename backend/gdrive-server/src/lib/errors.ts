/**
 * Custom Error Classes for Google Drive MCP Server
 *
 ...
 * Wraps Google Drive-specific API errors
 */
export class GdriveApiError extends McpError {
  constructor(
    message: string,
    ...
    super(message, statusCode, 'GDRIVE_API_ERROR');
  }
}
