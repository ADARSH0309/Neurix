/**
 * Custom Error Classes for Google Tasks MCP Server
 *
 ...
 * Wraps Google Tasks-specific API errors
 */
export class GtaskApiError extends McpError {
  constructor(
    message: string,
    ...
    super(message, statusCode, 'GTASK_API_ERROR');
  }
}
...
export function isRetryableError(error: unknown): boolean {
  ...
  if (error instanceof GtaskApiError) {
