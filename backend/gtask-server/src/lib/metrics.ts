/**
 * Prometheus Metrics for Google Tasks MCP Server
 *
...
export const toolCallCounter = new promClient.Counter({
  name: 'gtask_mcp_tool_calls_total',
...
export const toolCallDuration = new promClient.Histogram({
  name: 'gtask_mcp_tool_call_duration_seconds',
...
export const activeToolCalls = new promClient.Gauge({
  name: 'gtask_mcp_active_tool_calls',
...
export const activeSessions = new promClient.Gauge({
  name: 'gtask_mcp_active_sessions',
...
export const sessionEvents = new promClient.Counter({
  name: 'gtask_mcp_session_events_total',
...
export const oauthEvents = new promClient.Counter({
  name: 'gtask_mcp_oauth_events_total',
...
// ============================================================================
// Google Tasks API Metrics
// ============================================================================

/**
 * Counter: Google Tasks API calls
 */
export const gtaskApiCalls = new promClient.Counter({
  name: 'gtask_mcp_gtask_api_calls_total',
  help: 'Total Google Tasks API calls',
  labelNames: ['operation', 'status'] as const,
  registers: [register],
});

/**
 * Histogram: Google Tasks API latency
 */
export const gtaskApiLatency = new promClient.Histogram({
  name: 'gtask_mcp_gtask_api_latency_seconds',
  help: 'Google Tasks API call latency in seconds',
...
export const circuitBreakerState = new promClient.Gauge({
  name: 'gtask_mcp_circuit_breaker_state',
...
export const circuitBreakerEvents = new promClient.Counter({
  name: 'gtask_mcp_circuit_breaker_events_total',
...
export const rateLimitEvents = new promClient.Counter({
  name: 'gtask_mcp_rate_limit_events_total',
...
export const httpRequestsTotal = new promClient.Counter({
  name: 'gtask_mcp_http_requests_total',
...
export const httpRequestDuration = new promClient.Histogram({
  name: 'gtask_mcp_http_request_duration_seconds',
...
/**
 * Record Google Tasks API call metrics
 */
export function recordGtaskApiCall(
  operation: string,
  status: 'success' | 'error',
  durationMs: number
): void {
  gtaskApiCalls.inc({ operation, status });
  gtaskApiLatency.observe({ operation }, durationMs / 1000);
}
