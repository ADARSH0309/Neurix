...
export const authLimiter = rateLimit({
  ...
  legacyHeaders: false,
  store: new IORedisStore({ prefix: 'rl:gtask:auth:' }),
  handler: (req, res) => {
...
export const apiLimiter = rateLimit({
  ...
  standardHeaders: true,
  legacyHeaders: false,
  store: new IORedisStore({ prefix: 'rl:gtask:api:' }),
  handler: (req, res) => {
    console.error(JSON.stringify({
      timestamp: new Date().toISOString(),
      level: 'warn',
...
export const tokenGenerationLimiter = rateLimit({
  ...
  standardHeaders: true,
  legacyHeaders: false,
  store: new IORedisStore({ prefix: 'rl:gtask:token:' }),
  handler: (req, res) => {
    console.error(JSON.stringify({
      timestamp: new Date().toISOString(),
      level: 'warn',
...
export const sseLimiter = rateLimit({
  ...
  standardHeaders: true,
  legacyHeaders: false,
  store: new IORedisStore({ prefix: 'rl:gtask:sse:' }),
  handler: (req, res) => {
    console.error(JSON.stringify({
      timestamp: new Date().toISOString(),
      level: 'warn',
...
export const generalLimiter = rateLimit({
  ...
  standardHeaders: true,
  legacyHeaders: false,
  store: new IORedisStore({ prefix: 'rl:gtask:general:' }),
  handler: (req, res) => {
    console.error(JSON.stringify({
      timestamp: new Date().toISOString(),
      level: 'warn',
...
export const gdprDeletionLimiter = rateLimit({
  ...
  standardHeaders: true,
  legacyHeaders: false,
  store: new IORedisStore({ prefix: 'rl:gtask:gdpr:delete:' }),
  handler: (req, res) => {
...
export const gdprExportLimiter = rateLimit({
  ...
  standardHeaders: true,
  legacyHeaders: false,
  store: new IORedisStore({ prefix: 'rl:gtask:gdpr:export:' }),
  handler: (req, res) => {
